...
import org.dengine.habitrack.core.database.UnsupportedDatabaseVersionException
...
import org.dengine.habitrack.inject.DaggerHabitsApplicationComponent
...
class HabitsApplication : Application() {
    ...
    companion object {
        ...
        fun isTestMode(): Boolean {
            return try {
                Class.forName("org.dengine.habitrack.BaseAndroidTest")
                true
